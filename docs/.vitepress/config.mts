...
export default defineConfig({
  base: isRunningOnVercel ? '/' : '/stratagems-wars/',
  title: "Stratagems Wars",
  description: "Build and Deploy for Eternity. Stratagems Wars is a production-ready template for decentralised applications.",
  head: [
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/wighawag/stratagems-wars#readme' },
