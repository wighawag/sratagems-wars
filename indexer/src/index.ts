...
import {Registry, type RegistryState} from 'stratagems-wars-common';
...
const StratagemsWarsIndexerProcessor: JSProcessor<MergedAbis<typeof contractsInfo.contracts>, RegistryState> = {
...
export const createProcessor = fromJSProcessor(() => StratagemsWarsIndexerProcessor);
...
const StratagemsWarsIndexerProcessor: JSProcessor<MergedAbis<typeof contractsInfo.contracts>, Data> = {
	// version is automatically populated via version.cjs to let the browser knows to reindex on changes
	version: '__VERSION_HASH__',
